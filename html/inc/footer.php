		...
		<div class="wd-inner">
			<div class="list-familySite">
				...
				<ul>
					...
					<li><a href="https://www.welcomeloan.co.kr" target="_blank">Welcome Loan</a></li>
					<li><a href="https://www.anyonecapital.co.kr/" target="_blank">Anyone Loan</a></li>
					<li><a href="http://www.welrixfni.com/" target="_blank">Welix F&amp;I</a></li>
					<li><a href="http://www.welrixcapital.com" target="_blank">Welix Capital</a></li>
					<li><a href="http://www.welrixrental.co.kr" target="_blank">Welix Rental</a></li>
				...
				<div class="box-inputType-1">
					...
					<div class="btn-fixed-inquery pc-btnFixed mo_btn">
						<div class="btn-fixedTwo type-2 pt20">
							...
							<div>
								<a href="#none" data-btn="motion" class="common-btnType-7 waves-effect waves-light btnSel-bg"><span>SEND</span></a><!-- class="btnSel-bg" 추가 버튼활성화 -->
							</div>
						</div>
					</div>
					<!-- //btn -->
...
<script type="text/javascript">
	...
	$(function(){
		...
		*/
		...
		$validationTgIq.on('keypress focusout', function(){
			var vIq = 0;
